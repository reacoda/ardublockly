...
Blockly.Blocks['servo_write'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("set Servo to Port")
        .appendField(new Blockly.FieldDropdown(
            Blockly.Arduino.Boards.selected.portsServo), 'SERVO_PIN');
...
Blockly.Blocks['servo_read'] = {
  ...
  init: function() {
    ...
    this.setColour(Blockly.Blocks.servo.HUE);
    this.appendDummyInput()
        .appendField("read Servo Port")
        .appendField(new Blockly.FieldDropdown(
            Blockly.Arduino.Boards.selected.ports), 'SERVO_PIN');
